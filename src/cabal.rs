...
-- publish packages generated by `cabal-pack` on Hackage. While it is pretty
...
-- This file was generated by `cabal-pack`, but please don't hesitate to edit it!

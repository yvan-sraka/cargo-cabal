-- This file was generated by `cabal-pack`, its goal is to define few hooks
...
--
-- This handy automation (particularly useful when you want to quickly
-- prototype without having to spawn manually `cargo` commands) is disabled by
-- default.
